...
<body
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                @elseif ($user->auth == 'SuperAdmin')
                                    ...
                                    <a class="dropdown-item" href="{{ url('setting-superadmin') }}">
                                        <i class="feather icon-settings"></i> Settings
                                    </a>
                                @else
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @if (auth::user()->auth == 'Admin')
                    ...
                    <li
                        class="nav-item {{ request()->routeIs('admin-laporan.harian', 'admin-laporan.bulanan', 'admin-laporan.tahunan', 'admin-laporan.total') ? 'active' : '' }}">
                ...
                @elseif(auth::user()->auth == 'SuperAdmin')
                    <li
                        ...
                        <a href="{{ route('superadmin.transaksi') }}"><i class="feather icon-shopping-cart"></i><span
                                class="menu-title" data-i18n="Dashboard">Data Transaksi</span></a>
                    </li>
                    ...
                    <li class=" nav-item"><a href="#"><i class="feather icon-users"></i><span
                        ...
                        <ul class="menu-content">
                            <li class="nav-item {{ request()->is('kelola-admin') ? 'active' : '' }}">
                                <a href="{{ url('kelola-admin') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Data Admin</span></a>
                            </li>
                            <li class="nav-item {{ request()->is('supercustomer') ? 'active' : '' }}">
                                <a href="{{ url('supercustomer') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Data Customer</span></a>
                            </li>
                            <li class="nav-item {{ request()->is('karyawan') ? 'active' : '' }}">
                                <a href="{{ url('karyawan') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Data Karyawan</span></a>
                            </li>
                    ...
                    <li class=" nav-item"><a href="#"><i class="feather icon-archive"></i><span
                                class="menu-title" data-i18n="User">Data Inventaris</span></a>
                        <ul class="menu-content">
                            <li
                                class="nav-item {{ request()->routeIs('kategori.index', 'kategori.create', 'kategori.edit') ? 'active' : '' }}">
                                <a href="{{ url('kategori') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Kategori</span></a>
                            </li>
                            <li
                    ...
                    <li class=" nav-item"><a href="#"><i class="feather icon-dollar-sign"></i><span
                                class="menu-title" data-i18n="User">Data Keuangan</span></a>
                        <ul class="menu-content">
                            <li class="nav-item {{ request()->is('data-finance') ? 'active' : '' }}">
                                <a href="{{ url('data-finance') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Total</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('pemasukan.index', 'pemasukan.create', 'pemasukan.edit') ? 'active' : '' }}">
                                <a href="{{ url('pemasukan') }}"><i class="feather icon-circle"></i><span
                                        class="menu-title" data-i18n="List">Pemasukan</span></a>
                            </li>
                            <li
                                class="nav-item {{ request()->routeIs('pengeluaran.index', 'pengeluaran.create', 'pengeluaran.edit') ? 'active' : '' }}">
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0"><span
                class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2025<a
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var lat = parseFloat("{{ $user->customer->latitude ?? '-6.200000' }}");
            var lng = parseFloat("{{ $user->customer->longitude ?? '106.816666' }}");
