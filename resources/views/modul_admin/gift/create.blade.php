...
@section('title', 'Form Tambah Data Gift')
@section('header', 'Tambah Gift')
@section('content')
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Form Tambah Data Gift</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    ...
                    @enderror
                    <form action="{{ route('gift.store') }}" method="POST" class="form form-vertical">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gift" id="gift"
                                            ...
                                            placeholder="Masukkan nama gift" value="{{ old('gift') }}">
                                        @error('gift')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
