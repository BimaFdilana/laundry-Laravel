<div class="modal fade" id="ubah_status_satuan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel2">Ubah Status Order</h4>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="save_status_satuan">Save</button>
