...
<body onload="window.print();">
    <div class="receipt">
        ...
        <p>
            ...
            Pembayaran: {{ $transaksi->jenis_pembayaran }} ({{ $transaksi->info_pembayaran }})
        </p>
        ...
        <p><strong>Diskon: Rp {{ number_format($transaksi->disc, 0, ',', '.') }}</strong></p>
        <p><strong>Harga Akhir: Rp {{ number_format($transaksi->harga_akhir, 0, ',', '.') }}</strong></p>
        <div class="center">
            Terima kasih!
        </div>
    </div>
    ...
    <div class="no-print" style="margin-top: 20px; text-align: center;">
        <a href="{{ route('transaksi-satuan.index') }}">
            <button>Kembali ke Transaksi Satuan</button>
        </a>
    </div>
</body>
