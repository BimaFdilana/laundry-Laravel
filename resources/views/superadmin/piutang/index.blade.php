...
@section('title', 'Super Admin - Data Piutang')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <form method="GET" action="{{ route('superadmin.piutang.index') }}" class="form-inline">
                            ...
                            @if ($customer)
                                <a href="{{ route('superadmin.piutang.index') }}" class="btn btn-secondary ml-1">Reset</a>
                            @endif
                        </form>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($piutang as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('superadmin.piutang.bayar', ['tipe' => $item['tipe'], 'id' => $item['id']]) }}"
