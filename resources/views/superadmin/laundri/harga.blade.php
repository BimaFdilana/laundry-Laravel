...
@section('title', 'Super Admin - Data Layanan Laundry')
@section('content')
    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> Data Layanan Laundry</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-warning" data-toggle="modal"
                                                    ...
                                                    data-id-jenis="{{ $item->jenis }}" data-id-kg="{{ $item->kg }}"
                                                    data-id-harga="{{ $item->harga }}" data-id-hari="{{ $item->hari }}"
                                                    data-id-status="{{ $item->status }}" id="click_harga"
                                                    data-target="#edit_harga" style="color:white">Edit</a>
                                            </td>
                                        </tr>
                                        @php $no++; @endphp
                                    @endforeach
                        ...
                        @include('superadmin.laundri.editharga')
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-black">Form Tambah Data Layanan</h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="form-group has-success">
                                            ...
                                            <input type="text" name="nama" value="{{ old('nama') }}"
                                                ...
                                                placeholder="Tambahkan Nama Layanan" required autocomplete="off">
                                            @error('jenis')
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="form-group has-success">
                                            ...
                                            <input type="text" name="jenis" value="{{ old('jenis') }}"
                                                ...
                                                placeholder="Tambahkan Jenis Layanan" required autocomplete="off">
                                            @error('jenis')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
