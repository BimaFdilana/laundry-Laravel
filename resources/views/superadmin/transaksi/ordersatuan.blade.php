                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->status_payment == 'Pending')
                                        <form action="{{ route('superadmin.ubahstatusbayarsatuan', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Ubah status pembayaran menjadi Lunas?')">
                                            @csrf
                                            @method('PUT')
                                    ...
                                    @elseif($item->status_payment == 'Success')
                                        <form action="{{ route('superadmin.ubahstatusbayarsatuan', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Ubah status pembayaran menjadi Belum Bayar?')">
                                            @csrf
                                            @method('PUT')
