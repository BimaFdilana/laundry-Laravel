...
@endsection
@section('content')
    <!-- Baris Kelola Pengguna (Superadmin Special) -->
    <div class="row">
        <div class="col-lg-4 col-sm-4 col-12">
            <a href="{{ route('kelola-admin.index') }}" style="text-decoration: none; color: inherit;">
                <div class="card hover-shadow shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center py-1">
                        <div>
                            <h2 class="text-bold-700 mb-0 text-primary">{{ $jumlahAdmin }}</h2>
                            <p class="text-muted mb-0 font-weight-bold">Jumlah Admin</p>
                        </div>
        ...
        <div class="col-lg-4 col-sm-4 col-12">
            <a href="{{ route('karyawan.index') }}" style="text-decoration: none; color: inherit;">
                <div class="card hover-shadow shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center py-1">
                        <div>
                            <h2 class="text-bold-700 mb-0 text-warning">{{ $jumlahKaryawan }}</h2>
                            <p class="text-muted mb-0 font-weight-bold">Jumlah Karyawan</p>
                        </div>
        ...
        <div class="col-lg-4 col-sm-4 col-12">
            <a href="{{ route('supercustomer.index') }}" style="text-decoration: none; color: inherit;">
                <div class="card hover-shadow shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center py-1">
                        <div>
                            <h2 class="text-bold-700 mb-0 text-success">{{ $jumlahCustomer }}</h2>
                            <p class="text-muted mb-0 font-weight-bold">Jumlah Customer</p>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            <a href="{{ route('superadmin.piutang.index') }}" style="text-decoration: none; color: inherit;">
                <div class="card bg-light-secondary border-secondary hover-shadow">
                    <div class="card-body d-flex justify-content-between align-items-center py-1">
                        <div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body py-1">
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <a href="{{ route('superadmin.aktivitas-karyawan.index') }}" class="btn btn-outline-warning mb-1 font-weight-bold">
