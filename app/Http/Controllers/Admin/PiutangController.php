...
class PiutangController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('modul_admin.piutang.index', compact('piutang', 'totalPiutang', 'listCustomer', 'customer'));
    }
    ...
    public function bayar(Request $request, $tipe, $id)
    {
        ...
        return redirect()->route('admin.piutang.index')->with('success', 'Piutang berhasil dilunasi.');
    }
}
